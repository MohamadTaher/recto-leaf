...
/** Mihon's adaptive sheet around Moon+'s compact read-aloud control model. */
@Composable
fun NovelSpeechSheet(
    speaking: Boolean,
    paused: Boolean,
    index: Int,
    count: Int,
...
private fun SpeechControls(
    ...
    Column(
        ...
        Text(
            text = stringResource(MR.strings.leaf_novel_reader_speech_controls),
        ...
        Row(
            ...
            IconButton(onClick = onStop, enabled = speaking) {
                Icon(
