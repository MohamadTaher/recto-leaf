...
object NovelHtmlSanitizer {
     ...
     * comes back out of [leaf.novel.epub.EpubPath.percentDecode] byte-identical.
     *
     * Hand-rolled rather than `Uri.encode` for the same reason [leaf.novel.epub.EpubPath] decodes by
