package leaf.novel.source.local
...
import leaf.novel.data.epub.novelEpubReader
import leaf.novel.source.LOCAL_NOVEL_SOURCE_ID
import leaf.novel.source.local.image.NovelCoverManager
import leaf.novel.source.local.io.NOVEL_BOOK_FILE
import leaf.novel.source.local.io.NOVEL_TMP_SUFFIX
...
class LocalNovelSource(
    ...
    companion object {
        /** See [leaf.novel.source.LOCAL_NOVEL_SOURCE_ID], which `:data` also needs. */
